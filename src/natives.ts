...
(function() {
  "use strict";
  var ArrayClassData, JavaArray, JavaObject, PrimitiveClassData, ReferenceClassData, arraycopy_check, arraycopy_no_check, create_stack_trace, debug, doPrivileged, error, exceptions, flatten_pkg, fs, gLong, get_cl_from_jclo, get_property, log, native_define_class, native_methods, o, path, root, runtime, setup_caller_stack, stat_fd, stat_file, thread_name, trace, trapped_methods, unsafe_compare_and_swap, unsafe_memcpy, util, write_to_file, _, _ref, _ref1, _ref2, _ref3, _ref4,
  ...
  _ref1 = require('./logging'), log = _ref1.log, debug = _ref1.debug, error = _ref1.error, trace = _ref1.trace;
  ...
  _ref4 = require('./ClassData'), ReferenceClassData = _ref4.ReferenceClassData, PrimitiveClassData = _ref4.PrimitiveClassData, ArrayClassData = _ref4.ArrayClassData;
              ...
              return stat_file(filepath, function(stat) {
                if (stat != null) {
                  ...
                  return fs.open(filepath, 'w', function(err, fd) {
                    if (err != null) {
                      return except_cb(function() {
                        return rs.java_throw(rs.get_bs_class('Ljava/io/IOException;'), e.message);
                      });
                    } else {
                      return fs.close(fd, function(err) {
                        if (err != null) {
