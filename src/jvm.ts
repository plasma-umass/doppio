...
export class JVM {
  public static show_NYI_natives: bool = false;
  public static dump_state: bool = false;
  private static vendor_path = typeof node !== "undefined" ? '/home/doppio/vendor' : path.resolve(__dirname, '../vendor');
  private static system_properties: {string: any; };

  public static reset_system_properties() {
    this.system_properties = {
      'java.class.path': [],
      'java.home': "" + this.vendor_path + "/java_home",
      'sun.boot.class.path': "" + this.vendor_path + "/classes",
      'file.encoding': 'UTF-8',
      'java.vendor': 'Doppio',
      'java.version': '1.6',
  ...
  public static read_classfile(cls: any, cb: any, failure_cb: (exp_cb: ()=>void)=>void) {
  ...
  public static set_classpath(jcl_path: string, classpath: string) {
  ...
  public static run_class(rs: any, class_name: string, cmdline_args: string[], done_cb: (arg: any)=>void) {
