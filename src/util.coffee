...
root.int_mod = (rs, a, b) ->
  exceptions.java_throw rs, rs.class_lookup(c2t 'java/lang/ArithmeticException'), '/ by zero' if b == 0
  a % b
...
root.long_mod = (rs, a, b) ->
  exceptions.java_throw rs, rs.class_lookup(c2t 'java/lang/ArithmeticException'), '/ by zero' if b.isZero()
  a.modulo(b)
